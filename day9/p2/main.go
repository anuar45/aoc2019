			...
			case 0:
				...
				case 0:
					...
					case 0:
						...
						i += 4
					case 2:
						nums[cmp.Base+nums[i+3]] = nums[nums[i+1]] + nums[nums[i+2]]
						i += 4
					}
				case 1:
					switch opCode[len(opCode)-5] {
					case 0:
						...
						i += 4
					case 2:
						nums[cmp.Base+nums[i+3]] = nums[nums[i+1]] + nums[i+2]
						i += 4
					}
				case 2:
					switch opCode[len(opCode)-5] {
					case 0:
						...
						i += 4
					case 2:
						nums[cmp.Base+nums[i+3]] = nums[nums[i+1]] + nums[cmp.Base+nums[i+2]]
						i += 4
					}
				}
			case 1:
				...
				case 0:
					...
					case 0:
						...
						i += 4
					case 2:
						nums[cmp.Base+nums[i+3]] = nums[i+1] + nums[nums[i+2]]
						i += 4
					}
				case 1:
					switch opCode[len(opCode)-5] {
				...
				case 2:
					...
					case 0:
						...
						i += 4
					case 2:
						nums[cmp.Base+nums[i+3]] = nums[i+1] + nums[cmp.Base+nums[i+2]]
						i += 4
					}
				}
			case 2:
				...
				case 0:
					...
					case 0:
						...
						i += 4
					case 2:
						nums[cmp.Base+nums[i+3]] = nums[cmp.Base+nums[i+1]] + nums[nums[i+2]]
						i += 4
					}
				case 1:
					switch opCode[len(opCode)-5] {
					case 0:
						...
						i += 4
					case 2:
						nums[cmp.Base+nums[i+3]] = nums[cmp.Base+nums[i+1]] + nums[i+2]
						i += 4
					}
				case 2:
					switch opCode[len(opCode)-5] {
					case 0:
						...
						i += 4
					case 2:
						nums[cmp.Base+nums[i+3]] = nums[cmp.Base+nums[i+1]] + nums[cmp.Base+nums[i+2]]
						i += 4
					}
				}
			}
